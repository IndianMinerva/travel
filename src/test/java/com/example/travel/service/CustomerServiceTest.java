...
public class CustomerServiceTest {
    ...
    public void givenCustomers_should_returnCustomers() throws ParseException {
        ...
        //Given
        customerService.createCustomer(new CustomerCreationUpdationRequest("AAA", "BBB", dateFormat.parse("01.01.2000")));
        customerService.createCustomer(new CustomerCreationUpdationRequest("DEF", "GHI", dateFormat.parse("01.01.1990")));
